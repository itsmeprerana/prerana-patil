...
function loadsrc(srcid) {
        switch (srcid) {
            case "facebook":
                window.location.href ="http://www.facebook.com/prerana.patil.3954";
                break;
            //case "twitter":
           ...
           /* case "telegram":
                ...
                break;*/
            case "whatsapp":
                window.location.href ="https://leadsguru.in/";
                break;
            case "linkedin":
                window.location.href ="https://www.linkedin.com/in/prerana-patil-377b90225/";
                break;
            case "instagram":
                window.location.href ="http://www.instagram.com/earnwith_prerana";
                break;
            case "github":
                window.location.href = "https://github.com/theprerana";
                break;
            case "resume":
                window.location.href = "#";
                break;
